...
translate([-30,47,-38])rotate([90,0,0])
translate([67.68,65,-100])rotate([0,0,-90])
...
difference(){
union(){
translate([0,0,-1.5])cylinder(d=18,h=13.5,$fn=60);
...
translate([0,0,-2])cylinder(d=6.1,h=20,$fn=30);
}
